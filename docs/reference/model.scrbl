...
and a package build procedure for processing. In this sense, a
@tech{package definition} is a branded program that, when executed,
...
@|project-name| implements a garbage collector that deletes any file
or directory with no known symbolic links.
