...
@racketmodname[xiden/pkgdef] reprovides the following bindings from
modules in the @racketmodname[xiden] collection:
...
@item{@racket[hex]}
@item{@racket[in-paths]}
@item{@racket[input]}
@item{@racket[install]}
@item{@racket[integrity]}
@item{@racket[logged-unit]}
@item{@racket[mdo]}
@item{@racket[path-matching]}
@item{@racket[release-input]}
@item{@racket[resolve-input]}
@item{@racket[run]}
...
Finally, the following bindings are generated by the language itself
for each module.
